...
context: L'identité visuelle du Conservatoire Pierre Barbizet de Marseille
  ...
  puise son inspiration dans l'architecture même du bâtiment, dans la diversité
  des disciplines artistiques qu'il accueille, ainsi que dans la lumière si
  singulière de Marseille.
approach: >-
  Le logotype a été conçu à partir de formes architecturales issues du
  conservatoire, traduites graphiquement pour devenir signes et structures
  visuelles. Il évoque l'idée de partition construite, d'architecture sonore et
  pédagogique.
